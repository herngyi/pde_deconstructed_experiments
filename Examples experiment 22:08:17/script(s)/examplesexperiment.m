...
%resolution of the Laplace equation on deconstructed domains on various
...
for j=1:length(examples)
    ...
    h=[];
    for i=1:8
        [TVA,TFA,TNA,na,TVB,TFB,TNB,nb,TH]=example(examples(j,:),.1/(2^i));
        [l2naiv,l2delt,l2non,l2neuman]=comparison(TVA,TFA,TNA,na,TVB,TFB,TNB,nb,@(x,y) x*y,TH);
